...
export default function AdminBloqueos({ apiUrl, adminToken }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <form onSubmit={crearBloqueo} className="bg-slate-900 border border-slate-800 rounded-2xl p-4 space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <p className="text-[10px] text-slate-500 mt-1">“Todas” bloqueará el horario para todo el club.</p>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            <label className="block text-xs font-semibold text-slate-300 mb-1">Hora desde (opcional)</label>
            <input
              type="time"
              value={horaDesde}
          ...
          <div>
            <label className="block text-xs font-semibold text-slate-300 mb-1">Hora hasta (opcional)</label>
            <input
              type="time"
              value={horaHasta}
              ...
              className="w-full text-xs bg-slate-950 border border-slate-700 rounded-lg px-3 py-2 focus:outline-none focus:ring-1 focus:ring-emerald-500"
            />
            <p className="text-[10px] text-slate-500 mt-1">Si no se especifican horas, el bloqueo aplica a todo el día.</p>
          </div>
        </div>
      ...
      <div className="pt-4 border-t border-slate-800/60 space-y-4">
        ...
        <form onSubmit={crearBloqueoFijo} className="bg-slate-900 border border-slate-800 rounded-2xl p-4 space-y-4">
          ...
          <div>
            ...
            <p className="text-[10px] text-slate-500 mt-1">Seleccioná uno o más días (ej: Lun/Mié/Jue).</p>
          </div>
          ...
          <div className="flex justify-end">
            <button
              ...
              className="px-4 py-2 text-xs font-semibold rounded-xl bg-emerald-500 hover:bg-emerald-600 disabled:opacity-60 text-white transition-colors"
            >
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 space-y-3">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
            <div>
              ...
              <p className="text-[11px] text-slate-400 mt-0.5">
                Mostrando <span className="text-slate-200 font-semibold">{totalFijosFiltrados}</span> de{" "}
                <span className="text-slate-200 font-semibold">{totalFijos}</span>
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <div>
              <label className="block text-[11px] font-semibold text-slate-300 mb-1">Buscar por nombre</label>
              <input
                value={filtroNombre}
            ...
            <div>
              <label className="block text-[11px] font-semibold text-slate-300 mb-1">Cancha</label>
              <select
                value={filtroCancha}
            ...
            <div>
              <label className="block text-[11px] font-semibold text-slate-300 mb-1">Día</label>
              <select
                value={filtroDia}
          ...
          {totalFijos === 0 ? (
            ...
            <div className="text-xs text-slate-500">
              ...
              <button onClick={limpiarFiltros} className="text-emerald-300 hover:text-emerald-200 underline">
                Limpiar filtros
              </button>
            </div>
          ) : (
            <div className="space-y-2 max-h-96 overflow-y-auto pr-1">
              {bloqueosFijosFiltrados.map((b) => (
                <div
                  key={b.id}
                  className="border border-slate-800 rounded-xl p-3 flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3 bg-slate-950/50"
                >
                  <div className="space-y-1 text-xs">
                  ...
                  <div className="flex sm:justify-end">
                    <button
                      ...
                      className="w-full sm:w-auto text-[11px] px-3 py-2 rounded-lg bg-red-900/20 hover:bg-red-900/40 text-red-400 border border-red-500/30"
                    >
                      Eliminar
                    </button>
                  </div>
